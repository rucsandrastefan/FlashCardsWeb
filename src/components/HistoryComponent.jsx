  ...
  return (
    <div>
      ...
      <div className="flex justify-center items-center drop-shadow">
        <div className="flex items-center justify-center bg-white h-24 w-3/6 rounded-lg px-8 mt-4 animate">
      ...
      <div className="grid grid-cols-3 gap-8 px-24 mt-16 h-24 ">
        <button className="bg-[#9fa0ff] rounded-lg px-4 py-2 text-white hover:bg-[#babbff] hover:text-white transition-all duration-300 h-24" onClick={() => navigate('/flashcards/renaissance')}>
