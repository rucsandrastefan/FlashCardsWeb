...
const Hero = () => {
  ...
  return (
    <div className="text-white h-full flex items-center justify-center bg-[url('src/img/backgr.png')] bg-opacity-70 bg-cover">
      <div className="w-full mx-auto text-center flex flex-col justify-center mb-24">
        <p className=" text-3xl text-[#9fa0ff] font-bold pb-2">
